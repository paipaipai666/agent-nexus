...
AgentNexus combines LLM reasoning with 18 built-in tools, executing complex tasks through an FSM-driven safety loop. All data (vector store, memory, trace logs) stays entirely local.
