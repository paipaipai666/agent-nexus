...
def chat(
    ...
    def _show_step(c, msg: str):
        if msg.startswith("--- 第"):
            ...
            c.print(Panel(_escape(msg), border_style="blue", padding=(0, 2)))
        elif msg.startswith("行动:"):
            c.print(Panel(_escape(msg), border_style="yellow", padding=(0, 2)))
        elif msg.startswith("观察:"):
            c.print(Panel(_escape(msg), border_style="green", padding=(0, 2)))
