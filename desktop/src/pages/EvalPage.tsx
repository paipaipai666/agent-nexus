        ...
        {activeTab === 'tasks' && (
          <>
            ...
            {tasks.length === 0 ? (
              ...
              <div key={task.id} className="p-3 rounded-lg cursor-pointer" style={{ background: 'var(--surface-2)', border: '1px solid var(--border)', boxShadow: 'var(--shadow-card), var(--card-highlight)' }} onClick={() => handleShowTaskDetail(task.id)} onMouseEnter={e => e.currentTarget.style.background = 'var(--surface-3)'} onMouseLeave={e => e.currentTarget.style.background = 'var(--surface-2)'}>
        ...
        {activeTab === 'suites' && (
          <>
            ...
            {suites.length === 0 ? (
              ...
              <div key={suite.name} className="p-4 rounded-lg" style={{ background: 'var(--surface-2)', border: '1px solid var(--border)', boxShadow: 'var(--shadow-card), var(--card-highlight)' }}>
            ...
            {suiteResult ? (
              <div className="space-y-3">
                ...
                {suiteResult.task_reports?.map((tr: any) => (
                  <div key={tr.task_id} className="p-3 rounded-lg" style={{ background: 'var(--surface-2)', border: '1px solid var(--border)', boxShadow: 'var(--shadow-card), var(--card-highlight)' }}>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
        ...
        {activeTab === 'baselines' && (
          <>
            {baselines.length === 0 ? (
              ...
              <div key={bl.suite} className="p-4 rounded-lg" style={{ background: 'var(--surface-2)', border: '1px solid var(--border)', boxShadow: 'var(--shadow-card), var(--card-highlight)' }}>
                <div className="flex items-center justify-between mb-2">
