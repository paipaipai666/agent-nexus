...
![图片](https://mmbiz.qpic.cn/mmbiz_png/kN3t5R6pdz5wwL4WNKicCPQia1q1xM8RftQrOdSvF1tOD5ia3YesvgcfkLf5PjAG5aiapeotBmLfqriarLN1KRE5asJxdrxqvrL0IjlGia2ickbYFk/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=0)
...
![图片](https://mmbiz.qpic.cn/mmbiz_svg/Q3auHgzwzM4SsBk8BOayFedMwlEW2VOplsbRYwlBGrhal844LVLAadJRib8O4SeqkfBUMpGmuDs20Mtw9HGyIYdGZOuUdY61Zp857rSfPiaxB6UauYFjxhMg/640?wx_fmt=svg&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=1)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/kN3t5R6pdz7Ve7kYTvB6XydHywjNs4tzia9sPXQGlNc0ranILVia2NCaosKfHqeicXdibDXEujPy8icfWNMImS6m4rGb28twmxdibWlibQTbCb977A/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=2)
...
1. 生成评测报告：输出质量 × 成本 × 性能三大类指标，每条用例的通过与否由该数据集类型对应的主指标决定，确保评测结论聚焦核心能力。

![图片](https://mmbiz.qpic.cn/mmbiz_svg/Q3auHgzwzM7UbDIhEJh37T9t17OZhTgcAquviaU1FEhkfibYGXZGb3HLN8zqAaa5fiaQnqEO1hsf1Yr0OMPbnfMhsQpnwtdvjntTGW2JfgNDGgT4RNR7ISib6g/640?wx_fmt=svg&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=3)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/kN3t5R6pdz5MqVj4dHKzKR5ohbf5KqAUGxBL1Ul7Qz4gsjTFOOy6J5Lf2uzetCRH9Mj8rLUy9myWgiamqGJiaQiaWCtFatdTKHaLVxoPQciatCQ/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=4)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/kN3t5R6pdz6ZELQVJ7iaeGNyGj2vLRwhwzsxL2qNfic0BYtZ8ic2VDE3kOicQVotvbRoVAO8mZbxqvZEwDUErcd2HJkksf6vTDQLrB0w4g7gfkQ/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=5)

### **7.2 多维指标** 

**评测结果：**评测完成后，下方首先展示总用例数、通过数、失败数和通过率，支持导出 JSON 评测数据。

![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/kN3t5R6pdz45MLpQwt7icMebyU79rOEezMCgs0YibgicCrRNwSoxAmDLeYbYcZZSEskgkMib4LGS60ZcoTEgsMcBib6o7ENs6KOoXLPJLXMJwaps/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=6)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/kN3t5R6pdz7Gnia3lejBRldwfS3kUsUImsNDSIkvrefCQ1y6oP518a7lEaeVOVicLib7Tja5sPcIbnicQSiaY7b2oUXKzkmPwHibBQibzic4hdBR7HY/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=7)

![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/kN3t5R6pdz4lNuGuA1qpz9picCnsmZK1XSkTFVgibF7UNBSAia6eamORO263pDaPsVicoGhrCPMG4HlWRLDu4OJtNTGWxYpH6ZNbL2UoiatIGMhA/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=8)

**场景通过率**：以进度条的形式展示各业务场景（Trace 排查、错误码分析、标签使用分析、可见可售性分析、领域知识问答等）的通过率，按通过率从高到低排序，快速定位薄弱环节。

![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/kN3t5R6pdz5uZQgJpEOWUq7c4eyDM9hs8OiawIibf3y8ZKaAR3EZfGJXv0vGNDYIA2l1HAjMXynNIJblwiagopU1ia0ia9ZX8mh15XVdN36eIZsI/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=9)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/kN3t5R6pdz5uRgnxB97CTx2GhFUD3138Tibbib9UdyESNDd4ASH8ibUX5yU2Lm2P1BfiaW5YnxoYbdLTHRMhjRrlSayaVXOibe6QNSLG8iarmPFr4/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=10)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/kN3t5R6pdz6S1pAibKRNvIKQuASkGkbe5L9iawPDqu0PsClicXF22jiaotRpTw5icvm7hwt4M0ZdQTkX9nvKamzz2oUXiaMPV8y191O6ic9Zxmphsw/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=11)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/kN3t5R6pdz61U60BJf8jkR6x7YTtx0Hkian3SibzUHwaiaO2EWvzFujrAKK2YGibkD3dGl62dXVB0GCmicbaEFMkW0lUShibjQKhrtxjfOPhd7KXw/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=12)![img]()![img]()
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/kN3t5R6pdz4T2FU5z2AzQPQdCw2sB1rQkwUXsjsw1gmiaKxAVN9j5UBXsuVw9odGLtDGCGEfvIVa6NCeGbVr8HeTzbM5S1WlicwGOE9OXQxM4/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=15)

**评测指标配置。** 平台把前文归纳的六类 Judge Task 沉淀成一套内置的多维度评测 Prompt 模板，按评测数据集选用关联的指标类型，并由 LLM 对 Agent 输出进行结构化评分。

![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/kN3t5R6pdz4SsictQBiauUs5MRhcsEoJ41AiaSF4TGaK0YM8CVvv174yFVkr7y76NfIXYalzQLhj0NS6OvZf90Dz5fh9CWTGQghabOsLskycMM/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=16)![img]()![img]()
**Graph 场景配置。** 同一 Agent 的场景编排可能各有差异，不同 Agent 的业务规则并不完全一致。平台提供按 Agent 维度并隔离不同Graph（场景）的能力，每种场景可自动关联可用的评测数据集与评测范围。

![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/kN3t5R6pdz79yRJYkMdATmFS6GAfKmlC6DJcRpgBnnazItRwXMZA35hicCZK1rOmd89k2LWAvEzC2Y86cMP7jE6YARib9YXHvUanmXSswhXibY/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=19)

**可观测性增强。** 承接前文运行时的 EvalTrace 采集，平台在接入层做到了无侵入：通过拦截器自动记录 Token 消耗、延迟、工具调用记录及其返回结果，作为 Judge 打分的依据。

![图片](https://mmbiz.qpic.cn/mmbiz_png/kN3t5R6pdz6kHXWdf4UPRBwia1Gmg05GPCjbcibYBOPFicHtowe7UwKRILrYdlRRiboTtO8AqU0rknKKUpIz3hlTggA8c9O4rnTFAsOnTEKMKUk/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=20)
...
| **评测集：**专项场景：涵盖Trace排查、错误码分析、标签使用分析、可见可售性分析、变更记录溯源诊断通用场景：涵盖基础信息、数据库表、离线数据、接入管控、价格模型、变更消息、HSF接口 | **评测集：**基础技能评测集（按 Skill 维度构造）知识问答评测集（从知识库中抽取问答对）多轮对话评测集 （构造 2-5 轮的多轮对话链，覆盖上下文引用、话题切换、指代消解等场景）异常输入评测集（包含空输入、超长文本、乱码、特殊字符提问等）工具调用评测集多意图评测集模糊意图评测集长对话衰减评测集 |
